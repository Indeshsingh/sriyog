class AppHelpers {
  ...
  static List<String> bookSynopsis = [
    ...
    "A Programmers Guide to the Mind by Dr. Don D. Campbell explores the intersection of psychology and programming. It delves into cognitive science and how understanding the mind's processes can enhance programming skills and problem-solving abilities. The book offers insights into how mental models, biases, and cognitive patterns influence coding practices and teamwork in software development. It's a blend of psychology and practical advice for programmers looking to optimize their cognitive approaches.",
  ];
